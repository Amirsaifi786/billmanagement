...
define('PAYTM_MERCHANT_KEY', 'H&S2p4UPgnUjOBce'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'gfxdHS71198900042820'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_CALLBACK_URL 	= "https://www.webflowindia.com/all-spike/PaytmKit/pgResponse.php";
