                    ...
                    <div class="main-form">
                        ...
                        <div class="mandatory-data">
                            ...
                            <div class="form-field">
                                ...
                                <input id="surl" class="surl" name="surl" value="https://atharvktechnologies.com/easebuzz/web/response.php">
                            </div>
                            
                            <div class="form-field">
                                <label for="furl">Failure URL<sup>*</sup></label>
                                <input id="furl" class="furl" name="furl" value="https://atharvktechnologies.com/easebuzz/web/response.php">
                            </div>
