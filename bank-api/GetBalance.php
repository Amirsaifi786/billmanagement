...
$sendJsonData = [
    "ftxGetBalance"=> [
        "header"=> [
            ...
            "custID"=> "37497435",
            "acctNum"=> $acno,
            "getBalanceRefNo"=> $blncRefNo
        ]
    ]
];
$sendJsonData = json_encode($sendJsonData);
// $url = "https://uatskyway.yesbank.in/app/uat/APIBankingService/FTx/Payments/GetBalance"; // Replace with your API URL
$url = "https://skyway.yesbank.in/app/live/APIBankingService/FTx/Payments/GetBalance";
$headers = [
