(function ($) {
	...
	$('.product-large-slider').slick({
		...
		arrows: true,
		asNavFor: '.pro-nav',
		prevArrow: '<button class="slide-arrow prev-arrow fa fa-chevron-left"></button>',
		nextArrow: '<button class="slide-arrow next-arrow fa fa-chevron-right"></button>'
	});
...
$(document).ready(function () {
	...
	$(".fa-search").click(function () {
		$(".hsearch, .input").toggleClass("active");
