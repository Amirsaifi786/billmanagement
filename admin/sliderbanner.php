<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        if($delete)
        {
            ?>
            <script>
                window.location.assign('sliderbanner.php');
            </script>
            <?php
        }
        else
        {
              ?>
            <script>
                alert('Erorr! Please try again.');   window.location.assign('sliderbaner.php');
            </script>
            <?php
        }
    }
   ...
   <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title" style="display:inline;">Home Page Banners</h2>
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                          <?php $selecttest = mysqli_query($conn,"SELECT * FROM banner WHERE status = '1' AND type='banner' ");
                          $i=1;
                          ...
                          { 
                            ...
                            <td>
                                ...
                                <a class="btn mb-2 btn-danger" href="sliderbanner.php?id=<?php echo $fetchtest['id']; ?>&status=2">Delete</a>
                            </td>
