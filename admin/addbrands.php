<?php
   ...
   { 
       ...
       $insertdata = mysqli_query($conn,"INSERT INTO brands ( `name`,`image`, `date`) VALUES ('$name','$file','$date') ");
       if($insertdata)
       {
          $msg = '<div class="alert alert-primary alert-dismissible fade show" role="alert">
                    Brand added Successfully.
                    </div>';
             echo "<script>setTimeout(function(){ window.location = 'addbrands.php'; },2000);</script>";
        }
        else
        {
                      ...
                      <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                        <div class="form-row">
                          ...
                          <div class="col-md-6 mb-3">
                              ...
                              <input class="form-control" id="1111" name="name" type="text" placeholder="Brand Name">
                          </div>
                          </div>
                          <div class="form-row">
                          <div class="col-md-6 mb-3">
