...
<main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title" style="display:inline !important;">Product List (Approved)</h2>
              <a href="addproduct.php" class="btn btn-primary ml-3" style="float:right;" type="button">Add more +</a>
              <a href="addbulk.php" class="btn btn-primary ml-3" style="float:right;" type="button">Add Bulk Product </a>
               <div class="row my-4">
                <!-- Small table -->
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                            <?php 
                                $i=1;
                                $selectproduct = mysqli_query($conn,"SELECT * FROM product WHERE status = '1' ");
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="products.php?ided=<?php echo base64_encode($fetchproduct['id']); ?>&status=2">Delete</a>
                            </td>
